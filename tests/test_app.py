...
class AppTest(unittest.TestCase):
    ...
    def test_03(self):
        ...
        self.assertEqual(status_code, 200)
        self.maxDiff = None
        self.assertRegex(content, 'vrf definition vrf_test01')
        self.assertRegex(content, 'vrf definition vrf_test02')
        self.assertRegex(content, 'vrf definition vrf_test03')
